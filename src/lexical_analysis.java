// Generated from lexical_analysis.g4 by ANTLR 4.10.1
...
public class lexical_analysis extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"INCLUDE", "DEFINE", "IOSTREAM", "STRING", "VECTOR", "ALGORITHM", "FSTREAM", 
			"CSTLIB", "CTIME", "CMATH", "STDEXCEPT", "IOMANIP", "TUPLE", "UNORDEREDMAP", 
			"THREAD", "REGEX", "CHRONO", "LIST", "QUEUE", "STACK", "SET", "MAP", 
			"BITSET", "ARRAY", "FUNCTIONAL", "MEMORY", "ITERATOR", "RANDOM", "CCTYPE", 
			"CSTDDEF", "CSTDINT", "CASSERT", "ASM", "AUTO", "BOOL", "BREAK", "CASE", 
			"CATCH", "CHAR", "CONST", "COUT", "CIN", "CONSTEXPR", "CONTINUE", "DECLTYPE", 
			"DEFAULT", "DELETE", "DO", "DOUBLE", "ELSE", "ENUM", "EXPORT", "EXTERN", 
			"FALSE", "FLOAT", "FOR", "GOTO", "IF", "INLINE", "INT", "LONG", "NAMESPACE", 
			"NOEXCEPT", "NULLPTR", "REGISTER", "RETURN", "SHORT", "SIGNED", "SIZEOF", 
			"STATIC", "STATICASSERT", "STRUCT", "SWITCH", "TEMPLATE", "THREADLOCAL", 
			"THROW", "TRUE", "TRY", "TYPEDEF", "UNION", "UNSIGNED", "VOID", "VOLATILE", 
			"WCHAR", "WHILE", "CLASS", "DYNAMICCAST", "EXPLICIT", "FRIEND", "MUTABLE", 
			"NEW", "OPERATOR", "PRIVATE", "PROTECTED", "PUBLIC", "REINTERPRETCASE", 
			"STATICCAST", "THIS", "TYPEID", "TYPENAME", "VIRTUAL", "COLON", "SEMICOLON", 
			"COMMA", "TERNARY", "LBRACKET", "RBRACKET", "LCBRACKET", "RCBRACKET", 
			"LSQBRACKET", "RSQBRACKET", "DOT", "ADD", "SUB", "MUL", "DIV", "LNOT", 
			"BCOMP", "MOD", "LT", "GT", "BAND", "BOR", "BXOR", "ASSIGNMENT", "ARROW", 
			"INCREMENT", "DECREMENT", "LSHIFT", "RSHIFT", "LE", "GE", "LAND", "LOR", 
			"EQ", "NE", "ADDASSIGN", "SUBASSIGN", "MULASSIGN", "DIVASSIGN", "MODASSIGN", 
			"BANDASSIGN", "BORASSIGN", "BXORASSIGN", "LSHIFTASSIGN", "RSHIFTASSIGN", 
			"ID", "ID1", "INTEGER", "FLOATING", "HEX_LITERAL", "OCTAL_LITERAL", "BINARY_LITERAL", 
			"SCOMMENT", "MCOMMENT", "CHAR_LITERAL", "STRINGL", "WS"
		};
	}
	...
	public lexical_analysis(CharStream input) {
		super(input);
		_interp = new LexerATNSimulator(this,_ATN,_decisionToDFA,_sharedContextCache);
	}

	@Override
	public String getGrammarFileName() { return "lexical_analysis.g4"; }
